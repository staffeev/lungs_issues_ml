...
# TODO: попросить Ивана просмотреть, что можно убрать.
class ResNet(nn.Module):
    """ResNet - остаточная свёрточная сеть. Имеет много SkipConnection."""
    def __init__(self, in_channels=3):
        ...
        self.classifier = nn.Linear(4608, 3)
...
class Block(nn.Module):
    def __init__(self, in_channels: int, out_channels: int, stride: int=1, sampling=None):
        super().__init__()

        self.net = SkipConnection(
